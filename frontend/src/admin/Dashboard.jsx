            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:grid-cols-2 xl:grid-cols-4 lg:gap-4">
              ...
              <div className="px-5 h-36 rounded-lg bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-700 flex justify-between items-center">
                <div className="img">
                  <img
                    className="w-20"
                    src="https://firebasestorage.googleapis.com/v0/b/octa-tech-2f77d.appspot.com/o/Googly-Data%2FDollar%20Bag.png?alt=media&token=0c2d4c58-c497-4473-a301-d0685e02060c"
                    alt="Dollar Logo"
                  />
                </div>
              ...
              <div className="px-5 h-36 rounded-lg bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-700 flex justify-between items-center">
                <div className="img">
                  <img
                    className="w-20"
                    src="https://firebasestorage.googleapis.com/v0/b/octa-tech-2f77d.appspot.com/o/Googly-Data%2FShopping%20Bag.png?alt=media&token=abd260ea-a1dd-4ead-8094-ea1e961cb0ac"
                    alt="Bag Logo"
                  />
                </div>
